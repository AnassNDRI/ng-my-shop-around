...
export class AuthenticationService {
  ...
  url = this.apiService.baseUrl;
  baseUrl = this.url + '/users/signin';
  baseUrlRg = this.url + '/users/register-customer';
  baseUrlId = this.url + '/users/profile';
  ...
  register(credentials: {
    ...
    utilisateur_date_naissance: string;
    ...
    body.set(
      ...
      credentials.utilisateur_date_naissance
    );
    body.set('utilisateur_gsm', credentials.utilisateur_gsm);

    return this.http.post(this.baseUrlRg, body.toString(), httpOptions).pipe(
      map((data: any) => {
        if (data) {
  ...
  public getUser(): any {
    return this.http.get(this.baseUrlId).pipe(
      map((data: any) => {
        console.log('data', data);
