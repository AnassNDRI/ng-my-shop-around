...
const commandeController = require('../controllers/comd_Ctrl');
// import du router d'express  pour permettre la navigation
const router = express.Router();

// routes
router.get('/utilisateurs', auth, commandeController.findByAccount);
router.get('/list', auth, commandeController.fetchAll);
router.get('/detail/:id', auth,  commandeController.findById);
router.post('/register', auth, commandeController.create);
router.put('/update/:id', auth, commandeController.update);
router.delete('/delete/:id', auth, commandeController.delete);
